  ...
  return (
    <div>
      ...
      <Modal
        ...
        style={{ top: 10 }}
        title={
          <div style={{ background: '#001529', color: '#fff', padding: '10px 24px', display: 'flex', alignItems: 'center', gap: 12, fontWeight: 700 }}>
            <span>ITFACT ERP</span>
            <span style={{ opacity: 0.85, fontWeight: 600 }}>ENTRADA DE MATERIAL</span>
          </div>
        }
        styles={{ content: { borderRadius: 0, padding: 0, height: 'calc(100vh - 20px)' }, header: { padding: 0, margin: 0 }, body: { padding: '16px 24px', overflowY: 'auto', maxHeight: 'calc(100vh - 130px)' } }}
        footer={(
          <div style={{ padding: '10px 24px', textAlign: 'right', borderTop: '1px solid #f0f0f0' }}>
            <Space>
              <Button icon={<CloseOutlined />} onClick={() => setOpen(false)} style={{ textTransform: 'uppercase' }}>
                Cancelar
              </Button>
              <Button icon={<SaveOutlined />} type="primary" loading={saving} onClick={onSubmit} style={{ textTransform: 'uppercase' }}>
                Salvar Produto
              </Button>
            </Space>
          </div>
      ...
      >
        <Form form={form} layout="vertical" size="small" onValuesChange={handleValuesChange}>
          <Row gutter={16}>
            <Col span={12}>
              <Card title={<div style={{ backgroundColor: '#00BFFF', color: 'white', padding: '4px 8px', borderRadius: '4px' }}>DADOS DO PRODUTO</div>} style={{ marginBottom: 16 }}>
                <Row gutter={12}>
                  <Col span={8}><Form.Item name="sku" label="SKU" rules={[{ required: true }]}><Input placeholder="SKU" style={{ width: '100%', textTransform: 'uppercase' }} /></Form.Item></Col>
                  <Col span={8}><Form.Item name="manufacturerCode" label="CÓDIGO FABRICANTE"><Input placeholder="CÓDIGO" style={{ width: '100%', textTransform: 'uppercase' }} /></Form.Item></Col>
                  <Col span={8}><Form.Item name="internalCode" label="CÓDIGO INTERNO"><Input placeholder="CÓDIGO" style={{ width: '100%', textTransform: 'uppercase' }} /></Form.Item></Col>
                  <Col span={24}><Form.Item name="name" label="NOME DO PRODUTO *" rules={[{ required: true }]}><Input placeholder="DIGITE O NOME DO PRODUTO" style={{ width: '100%', textTransform: 'uppercase' }} /></Form.Item></Col>
                  <Col span={24}><Form.Item name="model" label="MODELO"><Input placeholder="DIGITE O MODELO" style={{ width: '100%', textTransform: 'uppercase' }} /></Form.Item></Col>
                  <Col span={12}><Form.Item name="category" label="CATEGORIA/DEPARTAMENTO"><Input placeholder="DIGITE A CATEGORIA" style={{ width: '100%', textTransform: 'uppercase' }} /></Form.Item></Col>
                  <Col span={12}><Form.Item name="manufacturer" label="FABRICANTE/MARCA"><Input placeholder="DIGITE O FABRICANTE" style={{ width: '100%', textTransform: 'uppercase' }} /></Form.Item></Col>
                  <Col span={24}><Form.Item name="origin" label="ORIGEM"><Input placeholder="DIGITE A ORIGEM" style={{ width: '100%', textTransform: 'uppercase' }} /></Form.Item></Col>
                  <Col span={24}><Form.Item name="description" label="DESCRIÇÃO DETALHADA"><Input.TextArea placeholder="DIGITE A DESCRIÇÃO DETALHADA DO PRODUTO" rows={2} style={{ width: '100%', textTransform: 'uppercase' }} /></Form.Item></Col>
                </Row>
              </Card>
            </Col>
            <Col span={12}>
              <Card title={<div style={{ backgroundColor: '#00BFFF', color: 'white', padding: '4px 8px', borderRadius: '4px' }}>CAMPOS ADICIONAIS</div>} style={{ marginBottom: 16 }}>
                <Row gutter={12}>
                  <Col span={12}><Form.Item name="expirationDate" label="DATA DE VALIDADE"> <DatePicker style={{ width: '100%' }} /> </Form.Item></Col>
                  <Col span={12}><Form.Item name="lotNumber" label="NÚMERO DE LOTE"> <Input placeholder="NÚMERO DE LOTE" style={{ width: '100%', textTransform: 'uppercase' }} /> </Form.Item></Col>
              ...
              <Card title={<div style={{ backgroundColor: '#00BFFF', color: 'white', padding: '4px 8px', borderRadius: '4px' }}>VALORES E CUSTOS</div>} style={{ marginBottom: 16 }}>
                <Row gutter={12}>
          ...
          <Row gutter={16}>
            <Col span={12}>
              <Card title={<div style={{ backgroundColor: '#00BFFF', color: 'white', padding: '4px 8px', borderRadius: '4px' }}>ESTOQUE E LOCALIZAÇÃO</div>} style={{ marginBottom: 16 }}>
                <Row gutter={12}>
                  ...
                  <Col span={8}><Form.Item name="aisle" label="CORREDOR"> <Input style={{ width: '100%', textTransform: 'uppercase' }} /> </Form.Item></Col>
                  <Col span={8}><Form.Item name="shelf" label="PRATELEIRA"> <Input style={{ width: '100%', textTransform: 'uppercase' }} /> </Form.Item></Col>
                  <Col span={8}><Form.Item name="position" label="POSIÇÃO"> <Input style={{ width: '100%', textTransform: 'uppercase' }} /> </Form.Item></Col>
                </Row>
              </Card>
            </Col>
            <Col span={12}>
              <Card title={<div style={{ backgroundColor: '#00BFFF', color: 'white', padding: '4px 8px', borderRadius: '4px' }}>FORNECEDOR E LOGÍSTICA</div>} style={{ marginBottom: 16 }}>
                <Row gutter={12}>
                  <Col span={12}><Form.Item name="supplierName" label="FORNECEDOR PRINCIPAL"> <Input style={{ width: '100%', textTransform: 'uppercase' }} /> </Form.Item></Col>
                  <Col span={12}><Form.Item name="supplierCode" label="CÓDIGO DO FORNECEDOR (REFERÊNCIA/NCM)"> <Input style={{ width: '100%', textTransform: 'uppercase' }} /> </Form.Item></Col>
                  <Col span={12}><Form.Item name="leadTimeDays" label="LEAD TIME (DIAS)"> <InputNumber min={0} style={{ width: '100%' }} /> </Form.Item></Col>
                  <Col span={12}><Form.Item name="barcode" label="CÓDIGO DE BARRAS (EAN/UPC)"> <Input style={{ width: '100%', textTransform: 'uppercase' }} /> </Form.Item></Col>
                </Row>
              </Card>
            </Col>
          </Row>
